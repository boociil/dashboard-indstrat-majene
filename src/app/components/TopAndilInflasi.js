...
export default function TopAndilInflasi({
  ...
  const dynamicHeight = Math.max(data.length * 55, 300);
  ...
  return (
    <div className="bg-white p-2 md:p-0">
      ...
      <div
        className="relative w-full overflow-y-auto overflow-x-auto bg-slate-50/30 rounded-2xl p-2 md:p-4 border border-slate-100 shadow-inner"
